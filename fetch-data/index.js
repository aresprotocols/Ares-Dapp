  ...
  return new Promise(async (resolve) => {
    const operator = await api.query.aresModule.aggregators(aggregatorAccount.address);
      ...
      if (operator.toJSON().block_number === 0) {
          console.log("before register aggregator")
