...
pub mod pallet {
	...
	impl<T:Config> Pallet<T> {
		...
		pub fn register_aggregator(origin: OriginFor<T>, source: Vec<u8>, alias: Vec<u8>, url: Vec<u8>) -> DispatchResult {
		...
		#[pallet::weight(10_000)]
		pub fn initiate_request(origin: OriginFor<T>, aggregator: T::AccountId, token: TokenSpec, data: Vec<u8>) -> DispatchResult {
